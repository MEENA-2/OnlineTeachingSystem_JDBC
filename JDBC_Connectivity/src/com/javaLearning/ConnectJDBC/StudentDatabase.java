package com.javaLearning.ConnectJDBC;

import java.sql.*;
import java.util.Scanner;

/* In this class, in various methods defined here, For writing query, Statement is created. 
 * records are displayed with the help of resultSet class and the inbuilt methods 
 * like next(), getInt(), getString().
 * Prepared statement is created when user input is expected to completely execute the mysql query
